...
def process_data():
    ...
    for col in student_cols:
        # Fill missing with median for scoring? Or just ignore?
        # Let's fill na with median to allow score calculation for incomplete data rows
        # But this might be misleading. 
        # Let's do: if value is missing, it doesn't contribute to score, or we penalize?
        # If we fill with MAX (worst), it penalizes. 
